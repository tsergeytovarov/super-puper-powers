...
- **Артефакт:** `docs/spp/01-discovery-report.md`; обязательные разделы: «Убийцы идеи» (или явное «не найдены»), рекомендация go / pivot / no-go с обоснованием.
