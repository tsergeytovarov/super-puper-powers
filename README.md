...
История изменений — в [CHANGELOG.md](./CHANGELOG.md). Текущая версия — 0.3.1: сборка плагина
(0.1.0), доработки по итогам двух догфуд-прогонов pipeline (0.2.0), явный вердикт по
дифференциатору в discovery (0.3.0) и авто-дизамбигуация оркестратора при активном
obra/superpowers (0.3.1).
